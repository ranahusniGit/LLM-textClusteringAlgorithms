...
model_name = 'CAMeL-Lab/bert-base-arabic-camelbert-mix'  # Replace with the desired model
...
file= open('camelbert_Watan_2004_stem.csv', mode='w', newline='', encoding="utf-8-sig") 
...
for i in range(len(content)):
   ...
   # The last hidden states (embeddings)
   last_hidden_states = outputs.last_hidden_state

   # Method 1: Embeddings for the [CLS] token (the first token)
   # Method 2: Average of all token embeddings
...
file= open('camelbert_Watan_2004.csv', mode='w', newline='', encoding="utf-8-sig") 
writer = csv.writer(file)        
